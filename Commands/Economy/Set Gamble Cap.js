...
$customemoji[RG_check] Success! The max chicken cost is **$message[1]**, the chances of winning in the first cf win is **$message[2]%** and **$message[3]** is the gamble capacity! $getservervar[symb]
