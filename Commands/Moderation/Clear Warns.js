...
$else
$endif
$senddm[$get[user];{author:Warning Cleared!}{description:**$usertag** removed your warning with the number **$get[warn]**!}{color:GREEN}{footer:Executed by $usertag}{timestamp}]
$setuservar[reason;$replacetext[$getuservar[reason;$get[user]];$advancedtextsplit[$getuservar[reason;$get[user]];&&;$sum[$get[warn];1]];;1];$get[user]]
$setuservar[wc;$sub[$getuservar[wc;$get[user]];1];$get[user]]
...
$onlyif[$message[2]<=$getuservar[wc;$get[user]];{description:The user only has **$getuservar[wc;$get[user]]** warnings!}{color:FF0000}]
